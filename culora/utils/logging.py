...
class LoggingService:
    ...
    def bind(self, **kwargs: Any) -> "LoggingService":
        """Create a new logger with additional context."""
        new_context = {**self.context, **kwargs}
        return LoggingService(self.name, new_context)
...
def get_logger(name: str, **context: Any) -> LoggingService:
    ...
    """
    return LoggingService(name, context)


# Performance timing decorator
def log_performance(logger: LoggingService, operation: str) -> Callable[..., Any]:
